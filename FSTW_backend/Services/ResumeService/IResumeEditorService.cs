...
namespace FSTW_backend.Services.ResumeService
{
    public interface IResumeEditorService
    {
        ...
        public Task<ResponseResult<OnlyResumeInfoDto>> GetOnlyResumeInfo(int userId, int resumeId);

        public Task<ResponseResult<int>> DeleteResume(int userId, int resumeId);

        public Task<ResponseResult<int>> ChangeResumeInfo(int userId, int resumeId, OnlyResumeInfoDto onlyResumeInfoDto);
    }
}
